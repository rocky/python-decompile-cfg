...
Options:
  -o <path>     output decompiled files to this path:
                ...
                <path>
                  decompile_ng -o /tmp bla/fasel.pyc bla/foo.pyc
                    -> /tmp/fasel.pyc_dis, /tmp/foo.pyc_dis
                  decompile_ng -o /tmp bla/fasel.pyc bar/foo.pyc
                    -> /tmp/bla/fasel.pyc_dis, /tmp/bar/foo.pyc_dis
                  decompile_ng -o /tmp /usr/lib/python1.5
...
from decompile_ng.main import main, status_msg
