...
class Python310BaseParser(PythonParser):
    ...
    def customize_grammar_rules(self, tokens, customize):
        ...
        # self.remove_rules_310()
        # self.check_reduce["break"] = "tokens"
        # self.check_reduce["for310"] = "tokens"
        # self.check_reduce["pop_return"] = "tokens"
        # self.check_reduce["whileTruestmt310"] = "tokens"
        # self.check_reduce["whilestmt310"] = "tokens"
        # self.check_reduce["try_elsestmtl310"] = "AST"

        # self.reduce_check_table["break"] = break_check
        # self.reduce_check_table["for310"] = for310_check
    ...
    def reduce_is_invalid(self, rule, ast, tokens, first, last):
        ...
        if invalid:
            return invalid
        lhs = rule[0]
        if lhs in ("whileTruestmt310", "whilestmt310"):
            jb_index = last - 1
