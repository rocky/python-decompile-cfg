...
from decompile_ng.semantics.consts import TABLE_DIRECT
from decompile_ng.semantics.customize310 import customize_for_version310
from decompile_ng.semantics.customize37 import customize_for_version37
...
def customize_for_version3(self, version):
    ...
    if version >= (3, 7):
        ...
        if version >= (3, 10):
            customize_for_version310(self, version)
            pass  # version >= 3.10
        pass  # 3.7
    return
