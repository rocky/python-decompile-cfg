...
from decompile_ng.semantics.helper import find_code_node
from decompile_ng.parsers.treenode import SyntaxTree
from decompile_ng.scanners.tok import NoneToken, Token
from decompile_ng.semantics.consts import RETURN_NONE, ASSIGN_DOC_STRING
