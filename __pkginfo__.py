...
entry_points = {
    "console_scripts": [
        "decompile-cfg=decompyle3.bin.decompile:main_bin",
        "decompile-cfg-code=decompyle3.bin.decompile_code_type:main",
        "decompile-cfg-tokens=decompyle3.bin.decompile_tokens:main",
    ]
}
ftp_url = None
install_requires = ["click", "spark-parser >= 1.8.9, < 1.9.2", "xdis >= 6.1.1, < 6.3.0"]

license = "GPL3"
mailing_list = "python-debugger@googlegroups.com"
modname = "decompile-cfg"
py_modules = None
