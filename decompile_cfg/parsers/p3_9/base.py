...
class Python3_9BaseParser(PythonBaseParser):
    def __init__(self, start_symbol, debug_parser:dict=PARSER_DEFAULT_DEBUG):
        self.reduce_check_table = {}
        super(Python3_9BaseParser, self).__init__(start_symbol=start_symbol,
...
class Python3_9ParseSingle(Python3_9BaseParser, PythonParserSingle):
    pass
