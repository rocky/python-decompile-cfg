...
class Python3_10LambdaParser(Python3_10LambdaCustom, PythonParserLambda):
    ...
    def p_comprehension(self, _):
        ...
        comp_or         ::= comp_or_part BB_START
                            NOP BB_END BLOCK_END_FALLTHROUGH_JOIN BB_START
                            expr
        ...
        gen_comp_func   ::= GEN_START LOAD_ARG
                            for_iter
                            BB_START
                            store
                            comp_iter

        generator_exp   ::= GEN_START LOAD_ARG
                            BB_END
                            for_loop
                            bb_end_start
                            store
    ...
    def p_comprehension_list(self, _):
        ...
        set_comp        ::= GEN_START BUILD_SET_0 set_iter BLOCK_END_JOIN
