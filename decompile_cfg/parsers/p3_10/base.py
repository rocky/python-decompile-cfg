...
class Python3_10BaseParser(PythonBaseParser):
    def __init__(self, start_symbol, debug_parser:dict=PARSER_DEFAULT_DEBUG):
        self.reduce_check_table = {}
        super(Python3_10BaseParser, self).__init__(start_symbol=start_symbol,
...
class Python3_10ParseSingle(Python3_10BaseParser, PythonParserSingle):
    pass
