...
class Python39BaseParser(PythonBaseParser):
    def __init__(self, start_symbol, debug_parser:dict=PARSER_DEFAULT_DEBUG):
        self.reduce_check_table = {}
        super(Python39BaseParser, self).__init__(start_symbol=start_symbol, debug_parser=debug_parser)
...
class Python39ParseSingle(Python39BaseParser, PythonParserSingle):
    pass
