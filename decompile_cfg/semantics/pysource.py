...
"""Creates Python source code from an decompile_cfg parse tree.
...
import decompile_cfg.parsers.parse_heads as heads
import decompile_cfg.parsers.main as python_parser
    ...
    def comprehension_walk(self, node, iter_index, code_index=-5):
        ...
        while n == "comp_iter":  # list_iter
            ...
            if n == "comp_for":
                ...
                n = n[1]
            elif n in ("comp_if_not", "comp_if_not_and", "comp_if_or"):
                n = n[-1]
    ...
    def comprehension_walk_newer(self, node, iter_index: Optional[int], code_index: int = -5):
        ...
        while n in ("list_iter", "list_afor", "list_afor2", "comp_iter"):
            ...
            if n in ("list_for", "comp_for"):
                ...
                n = n[-1]
                assert n == "list_iter"
            elif n in ("comp_if_not_and", "comp_if_or"):
                if_nodes.append(n)
                n = n[-1]
                assert n == "comp_iter"
            elif n in (
        ...
        for if_node in if_nodes:
            self.write(" if ")
            if if_node in ("comp_if_not_and", "comp_if_or"):
